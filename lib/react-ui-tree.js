...
class UITree extends Component {
  ...
  drag = e => {
    ...
    let downCompareHeight = this.isRootTree ? this.getPrevElementHeight(this.dragging.dom) : dragging.h;
    let upCompareHeight = this.isRootTree ? -this.getNextElementHeight(this.dragging.dom) : 0;
